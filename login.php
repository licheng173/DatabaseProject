...
<head>
    ...
    <title>Cookzilla - Log In or Sign Up</title>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="text-center">
													<a href="Fpass.php" tabindex="5" class="forgot-password">Forgot Password?</a>
												</div>
											</div>
										</div>
									</div>
...
<footer id = "pagefooter">
            ...
            <div class="row">
                ...
                <div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
                    ...
                    <ul>
                        ...
                        <li> <a href="#"> Jobs at Cookzilla </a> </li>
                    </ul>
                </div>
                <div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
                    <h3> Advertising </h3>
                ...
                <div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
                    <h3> More </h3>
                    <ul>
                        <li> <a href="#"> Cookzilla APP </a> </li>
                        <li> <a href="#"> Food Wishes Viedo </a> </li>
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="pull-left"> Copyright © Cookzilla 2016. All right reserved. </p>
